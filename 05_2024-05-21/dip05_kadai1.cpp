...
int main(int argc, char *argv[]) {
    ...
    cv::VideoCapture capture("./src/scene.mov"); //指定したビデオファイルをオープン
    ...
    cv::VideoWriter rec("./dst/dip05_kadai1.mp4", cv::VideoWriter::fourcc('H','2','6','4'), 30, recImage.size());
    ...
    while (1) {
        ...
        //"grayImage"に線形空間フィルタ"kernel"を適用
        ...
        //2値化
        cv::threshold(lapImage, resultImage, 128, 255, cv::THRESH_BINARY);
